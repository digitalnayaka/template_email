      ...
      <v-tab-item>
        <v-col cols="12" sm="6" xs="6">
          <v-card class="d-flex justify-space-between align-center" flat>
            ...
            <v-img src="/img/icons/gradient.jpg" width="50" height="60"></v-img>
        ...
        <v-col cols="12">
          ...
          <div v-else>
            ...
            >Tawar Bersama {{ iklan.mst_iklan_type }} {{ iklan.mst_type_tb}}</span>
            <br />
            <div v-if="iklan.is_verified">Iklan ini membutuhkan tiket</div>
          ...
          <div> <h3> Harga Awal - Rp {{ Number(iklan.harga_awal).toLocaleString('id-ID') }} </h3> </div>
          <p
            class="text-center"
